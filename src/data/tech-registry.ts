...
const TECH_REGISTRY = {
  ...
  // ===== Technologies supplémentaires pour le CV de Goua Beedi =====
  'SQL': { color: '#336791' },
  'ETL': { color: '#1A7FBA' },
  'ELT': { color: '#1A7FBA' },
  'CI/CD': { color: '#E34F26' },
  'BM25': { color: '#FFCC00' },
  'Embeddings': { color: '#FF6F00' },
  'LLM': { color: '#412991' },
  'Monitoring': { color: '#FF4081' },
  'Data Quality': { color: '#8BC34A' },
  'Machine Learning': { color: '#FF5252' },
  'Statistiques': { color: '#607D8B' },
  'ETL/ELT': { color: '#1A7FBA' },
  'Scikit-learn': { color: '#F7931E' },
  'XGBoost': { color: '#00A676' },
  'Random Forest': { color: '#00695C' },
  'Annotation': { color: '#007ACC' },
  'Evaluation': { color: '#EC407A' },
  'OCR': { color: '#1976D2' },
